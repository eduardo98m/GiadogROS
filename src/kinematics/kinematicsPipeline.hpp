...
std::tuple<Eigen::VectorXd, 
           ...
           Eigen::Vector4d, 
           Eigen::Vector4d,
           Eigen::Vector4d> kinematicsPipeline(
    ...
    // PARAMS
    bool CARTESIAN_DELTA = config->CARTESIAN_DELTA;
    bool ANGULAR_DELTA   = config->ANGULAR_DELTA;
    double H_OFF         = config->H_OFF; // Hip offset
    ...
    std::tuple<
        ...
        Eigen::Vector4d,
        Eigen::Vector4d
    > FTG_data = compute_foot_trajectories(time, frequencies, config);
